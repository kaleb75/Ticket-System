...
*/
 ...
 //solicitarNumeroTicket();
 buscarDatos();
    }//GEN-LAST:event_formWindowOpened
/*private void solicitarNumeroTicket() {
    ...
    try {
      ...
      String mensaje = "<html>Your Ticket is: <H1><b>FIS-"+NumerodeTicket+"</b></h1></html>";
        ...
        // Si no se ingresa un número válido, puedes manejarlo aquí
        JOptionPane.showMessageDialog(this, "Número de ticket no válido. Por favor, ingrese un número válido.", "Error", JOptionPane.ERROR_MESSAGE);
        solicitarNumeroTicket(); // Vuelve a solicitar el número de ticket
    }}*/
